...
export default function ProfessionalSummary() {
  return (
    <section className="mb-12 print-break">
      <div className="bg-google-gray-50 rounded-2xl p-8 shadow-material hover:shadow-material-hover transition-all duration-200 hover:-translate-y-1">
        <h2 className="text-2xl font-semibold text-google-blue mb-4 flex items-center gap-3">
